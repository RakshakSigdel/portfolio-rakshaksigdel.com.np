...
const Banner = () => {
  return (
    <div className="sm:relative w-full bg-cover bg-center h-full" style={{ backgroundImage: `url(${background})`}}>
      <div className="absolute inset-0 sm:flex items-center sm:justify-start ml-8">
      ...
      <img src={person} alt="Person" className="absolute bottom-0 right-0 sm:h-5/6 object-contain" />
    </div>
  );
}
