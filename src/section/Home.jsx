    ...
    return (
        <div className="bg-white mx-4 md:mx-20">
            ...
            <SectionOverview
                ...
                descriptionPara2="Click on the My Skills button below to view my skills"
            ...
            <SectionOverview
                ...
                descriptionPara2="Click the My Projects button below to explore the projects I’ve been involved in."
                learnMorePath="/Projects"
            ...
            <SectionOverview
                ...
                descriptionPara2="Click the Contacts button below to find all the means of contact available for us to get connected"
